...
public class AccessToGoogleAboutPageElements extends Base{
    ...
    @Test
    public void accessToCommitmentButtonTest () throws InterruptedException {
        GoogleWebElements googleWebElements = new GoogleWebElements(driver);
        Thread.sleep(2000);
    ...
    @Test
    public void printTheTextOnConsole() throws InterruptedException {
        GoogleWebElements googleWebElements = new GoogleWebElements(driver);
        Thread.sleep(2000);
